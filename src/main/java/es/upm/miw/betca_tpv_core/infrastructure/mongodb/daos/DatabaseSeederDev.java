...
public class DatabaseSeederDev {
    ...
    private void seedDataBaseJava() {
        ...
        ComplaintEntity[] complaints = {
                ComplaintEntity.builder().id("dfun8ecm9cd").trackingCode("9B83A8").description("Queja aleatoria").reply("")
                ...
                ComplaintEntity.builder().id("frieourfncw0").trackingCode("6A6867").description("Queja articulo").reply("").state(ComplaintState.OPEN)
                        .article(articles[1]).registrationDate(dateComplaintCreationArticle1)
                        .userMobile("666666005").build(),
                ComplaintEntity.builder().id("fdfsdfsdfgfgdfgdfcer").trackingCode("9C27C5").description("Queja Asignatura").reply("Solucionado").state(ComplaintState.CLOSED)
